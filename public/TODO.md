...
- faire la page :
	...
	- liste des effets déja ajouté avec un bouton "+" tout en bas :
		- select pour l'effet (avec les effets déjà ajoutés en moins)
		- input pour la durée en tick
		- input pour l'amplification
		- bouton pour supprimer
		- coche pour les particules
		- coche pour les icônes
