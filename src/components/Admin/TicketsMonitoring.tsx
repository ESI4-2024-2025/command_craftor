...
function TicketsMonitoring() {
	...
	/**
	 * Check if the ticket is already registered in the list of tickets.
	 *
	...
	/**
	 * Set the first and second status based on the current ticket status.
	 */
	useEffect(() => {
	 ...
	 *
	 * @param ticket The ticket to display details for.
	 */
